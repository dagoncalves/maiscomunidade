...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'findme' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'findme' );
	?>
	<div class="quantity eltd-quantity-buttons">
		...
		<input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'findme' ) ?>"
